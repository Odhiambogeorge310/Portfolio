...
def web_portfolio():
    ...
    if selected == "About Me":
        ...
        - 🚀💼 Project links: | https://adidasanalytics.streamlit.app/ | [Cluster Dash](https://cluster-dash.streamlit.app/) | [School Dashboard](https://analysis-nmeet9epqso2u8t2jwjygx.streamlit.app/) |
